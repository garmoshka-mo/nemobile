function plusoInit(w, d) {
    var prot = /^((https|chrome-extension):)/i.test(w.location.protocol) ? "https" : "http", u = prot + "://share.pluso.ru", uid = "6084784518446292811", tags = "getElementsByTagName", h = d[tags]("body")[0], b = d.documentElement, db = d.body, compat = 0;
